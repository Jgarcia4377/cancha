...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/perfil', title: 'Mi Perfil', icon:'material-icons' },
    ...
    { path: '/canchas/canchas', title: 'Mis Canchas', icon:'material-icons' },
    ...
    // { path: '/alquiler/crear', title: 'Alquiler', icon:'material-icons' },
    { path: '/detalle', title: 'Alquiler', icon:'material-icons' },
    { path: '/tarifas/tarifas', title: 'Tarifas', icon:'pe-7s-plugin' }
